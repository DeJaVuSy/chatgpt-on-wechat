...
available_setting = {
    # openai api配置
    "open_ai_api_key": "sk-7HL6JKjH1GoIA9IjBWKNnbf7l4S3XIKUGP37v75kCJY5DKJ1",  # openai api key
    # openai apibase，当use_azure_chatgpt为true时，需要设置对应的api base
    "open_ai_api_base": "https://api.chatanywhere.cn",
    "proxy": "",  # openai使用的代理
    ...
    # Bot触发配置
    "single_chat_prefix": ["gpt", "@gpt"],  # 私聊时文本需要包含该前缀才能触发机器人回复
    "single_chat_reply_prefix": "[gpt] ",  # 私聊时自动回复的前缀，用于区分真人
